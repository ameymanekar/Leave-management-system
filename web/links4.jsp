  ...
  text-shadow: 4px 4px 6px rgba(255,255,255,0.46) ;
    ...
    <center>
        ...
        <table cellspacing="20px" width="100%" >
            <tr><td class="mbar" ><a class="mlink" href="home4.jsp" target="f2" >Home</a></td></tr>
            <tr><td class="mbar" ><a class="mlink" href="leavereqprincipal.jsp" target="f2" >LEAVES REQ</a></td></tr>
