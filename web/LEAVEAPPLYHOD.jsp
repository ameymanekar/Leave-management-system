...
<body>
    ...
    <from method="post" action="leaveapplyhodfrm.jsp">
<ul class="field-list">
    <form id="taxDetails">
						<li class="name">
							...
							<div class="form-input">
									...
									<input type="text" value="<%=(String)session.getAttribute("userid")%>" name="name2" placeholder="Full Name" required>
...
<div class="form-input">
    ...
    <select class="form-dropdown" name="province"  required >
...
<div class="submit_btn">
						<input type="submit" formaction="leaveapplyhodfrm.jsp" class="pure-button pure-button-primary" value="Submit">
