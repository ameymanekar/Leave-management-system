...
String sql ="select * from addstaff where sid="+sid;
	...
	<div class="heading">
		...
		<div class="container">
			<div class="agile-form">
				<form action="staffupdatefrm.jsp">
				<ul class="field-list">
                                    <li class="name">
						...
						<li>
							...
							<div class="form-input">
									...
									<input type="text"value="<%=resultSet.getString("name") %>" name="name" placeholder="Full Name" required>
						...
						<li> 
							...
							<div class="form-input">
								<input type="text"value="<%=resultSet.getString("contactno") %>" name="contactno" pattern="[1,2,3,4,5,6,7,8,9,0]{10}" placeholder="Phone Number" maxlength="10" required >
							</div>
						</li>
						...
						<li>
							...
							<div class="form-input">
								<select class="form-dropdown" name="department" required>
