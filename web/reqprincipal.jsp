...
String sql ="select * from leaveaddhod where sid="+sid;
			...
			<div class="agile-form">
				...
				<ul class="field-list">
							...
							<div class="form-input">
									...
									<input type="text"value="<%=resultSet.getString("sid") %>" name="sid"  required>
						...
						<li>
							...
							<div class="form-input">
									...
									<input type="text"value="<%=resultSet.getString("name2") %>" name="name2" placeholder="Full Name" required>
						...
						<li>
							...
							<div class="form-input">
								...
								<select class="form-dropdown" name="status2" required>
									<option value="">wait..</option>
									<option value="granted"> YES </option>
									<option value="Not granted"> NO </option>
									</select>
							</div>
						</li>
						...
						<li>
							...
							<div class="form-input">
                                                            ...
                                                            <input type="date" placeholder=""value="<%=resultSet.getString("DOBI") %>" name="DOBI" style="width: 98%; height: 30px;"  required> 
							...
							<div class="form-input">
                                                            ...
                                                            <input type="date" placeholder="" value="<%=resultSet.getString("DOBII") %>" name="DOBII" style="width: 98%; height: 30px;"  required> 
