...
<%
try{
connection = DriverManager.getConnection(connectionUrl+database, userid2, password);
statement=connection.createStatement();
String sql ="select * from loginmaster2 where sid="+sid;
			...
			<div class="agile-form">
				...
				<ul class="field-list">
							...
							<div class="form-input">
									...
									<input type="hidden"value="<%=resultSet.getString("userrole") %>" name="userrole"  required>
								
							</div>
						</li>
                                    <li class="name">
                                                       
							<label class="form-label"> User ID <span class="form-required"> * </span></label>
							<div class="form-input">
								
									<input type="text"value="<%=resultSet.getString("userid") %>" name="userid"  required>
							...
							<div class="form-input">
									...
									<input type="password" placeholder="password" id="password" style="width: 98%; height: 30px;" name="pwd"  required>
							...
							<div class="form-input">
									...
									<input type="password" placeholder="re password" id="confirm_password" style="width: 98%; height: 30px;" name="pwd" required>  
