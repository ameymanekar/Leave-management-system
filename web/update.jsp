...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
   ...
   <body>         
<center>
  <div class="enjoy-css2">  Update Data Of</div>
<table bstyle="width:100%" cellpadding="50px" cellspacing="50px" >
<form action="staffupdate2.jsp">
  <tr><td>  <input type="submit"class="enjoy-css" value="Staff"  /></td>
    
</form>
<form action="hodupdate2.jsp">
    <td><input type="submit"class="enjoy-css" value="HOD" /></td>
    
</form>
<form action="principalupdate2.jsp">
    <td><input type="submit"class="enjoy-css" value="Principal"  /></td></tr>
