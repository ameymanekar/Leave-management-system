...
<form action="staffadd.jsp" onsubmit="return myFunction()">
					<ul class="field-list">
						<li class="name">
						...
						<li> 
							...
							<div class="form-input">
								<input type="text" name="contactno" pattern="[1,2,3,4,5,6,7,8,9,0]{10}" placeholder="Phone Number" maxlength="10" required >
							</div>
						</li>
